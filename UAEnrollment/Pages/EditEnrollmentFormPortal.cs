...
{
    public partial class EditEnrollmentFormPortal : Form
    {
        ...
        public EditEnrollmentFormPortal()
        {
            InitializeComponent();
            Load += EditEnrollmentFormPortal_Shown;
        ...
        private void EditEnrollmentFormPortal_Shown(object sender, EventArgs e)
        {
            txtID.Text = StudentPortalAdmin.passStudentID;
            //txtContactNo.Text = "+63";
            LoadDetails();
        }
    }
